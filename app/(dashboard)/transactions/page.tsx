...
import { useSelectAccount } from "@/features/accountBank/hooks/use-select-account";
import {
...
const TransactionsPage = () => {
  ...
  const onSubmitImport = async (values: any) => {
    const accountBankId = (await confirm()) as string;
    if (!accountBankId) toast.error("Please select an account to continue!");
    const data = values.map((transaction: Transaction) => ({
      ...transaction,
      accountBankId,
    }));
